...
export default function Button({
  ...
  const styles = {
    ...
    roundedpr: `rounded-full text-xs md:text-sm bg-yellow-500 font-semibold uppercase self-end transition-colors duration-300 hover:bg-yellow-400 focus:bg-yellow-400 focus:outline-none px-4 py-3`,
    roundedsm: `rounded-full text-xs md:text-sm bg-yellow-500 font-semibold uppercase self-end transition-colors duration-300 hover:bg-yellow-400 focus:bg-yellow-400 focus:outline-none px-3 py-2`,
  };
  if (to)
    return (
